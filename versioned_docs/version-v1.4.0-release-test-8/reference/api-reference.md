...
- See the [OpenAPI specification](pathname:///redocusaurus/api-v1.4.0-release-test-8.yaml)
- See the [OpenApi documentation](/openapi-api-v1_4_0-release-test-8)
...
- See the [Protocol Buffer definitions ](pathname:///zenbpm-v1.4.0-release-test-8.proto)
