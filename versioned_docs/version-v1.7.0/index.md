...
- **REST API**: Documented in OpenAPI format: [documentation](static/openapi.mdx), [specification](pathname:///redocusaurus/api-v1.7.0.yaml)
- **gRPC API**: Defined in Protocol Buffers format: [specification](pathname:///zenbpm-v1.7.0.proto)
