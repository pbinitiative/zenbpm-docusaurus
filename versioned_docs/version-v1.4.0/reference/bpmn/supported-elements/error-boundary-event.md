...
This is the catch event behavior. Activities use stricter output propagation: without output mappings, activity output variables are not propagated. See [Variables](../variables.md).
