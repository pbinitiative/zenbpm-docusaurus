...
- **REST API**: Documented in OpenAPI format: [documentation](openapi.mdx), [specification](pathname:///redocusaurus/api-v1.0.0.yaml)
- **gRPC API**: Defined in Protocol Buffers format: [specification](pathname:///zenbpm-v1.0.0.proto)
