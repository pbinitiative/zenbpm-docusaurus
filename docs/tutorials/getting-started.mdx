...
<ApiOperation id="api" pointer="#/paths/~1process-instances~1{processInstanceKey}~1history/get" example={true} />
...
- Learn how to [create more complex BPMN processes](/future-feature) <sub>_`TODO`_</sub>
- Explore [user tasks and forms](/future-feature) <sub>_`TODO`_</sub>
- Understand [message events and correlation](/future-feature) <sub>_`TODO`_</sub>
- Set up [process monitoring and observability](/future-feature) <sub>_`TODO`_</sub>
