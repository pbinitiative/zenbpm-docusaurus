...
This page explains the ideas behind ZenBPM. You don't need to read it before the [Getting Started tutorial](../getting-started/first-bpmn-process) - but whenever a term there feels unclear, this is the place to look it up.
...
The [Getting Started tutorial](../getting-started/first-bpmn-process) walks this exact loop once, end to end.
...
- Run the loop yourself: [Getting Started tutorial](../getting-started/first-bpmn-process)
